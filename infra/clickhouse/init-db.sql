...
-- Note: User 'telemetry' is created automatically by Docker using environment variables
-- (CLICKHOUSE_USER and CLICKHOUSE_PASSWORD in docker-compose.yml)
...
-- Note: metrics and logs tables are defined in metrics-logs-schema.sql (02-metrics-logs.sql)
-- This ensures they have the complete schema with all SDK-required fields
