...
describe("Privacy Module", () => {
  ...
  describe("sanitizePhone", () => {
    ...
    it("should handle different phone formats", () => {
      expect(sanitizePhone("(555) 555-5555", { strategy: "truncate" })).toBe(
        "XXX-XXX-XXXX",
      );
      expect(sanitizePhone("555.555.5555", { strategy: "truncate" })).toBe(
        "XXX-XXX-XXXX",
  ...
  describe("sanitizeEmail", () => {
    ...
    it("should truncate email with truncate strategy", () => {
      const result = sanitizeEmail("testuser@example.com", {
        strategy: "truncate",
      });
  ...
  describe("sanitizeValue", () => {
    ...
    it("should sanitize API keys in strings", () => {
      const result = sanitizeValue(
        "Token: sk_test_fake1234567890abcdefghijklmnop",
      );
    ...
    it("should hit credit card sanitization for non-phone-like credit cards", () => {
      ...
      const complexInput =
        "Transaction ABC123 code:5500-0000-0000-0004 status:OK";
